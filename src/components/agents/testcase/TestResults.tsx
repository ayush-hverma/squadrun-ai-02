...
import { TestResults as TestResultsType } from '@/types/testTypes';
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="bg-squadrun-primary/10 rounded-md p-4">
            ...
            <div className="flex justify-between text-sm text-squadrun-gray mb-3">
              ...
              <span>Failed: {results.failed}/{results.total}</span>
            </div>
            <Progress value={results.passed / results.total * 100} className="h-2 bg-squadrun-darker" />
          </div>
          ...
          <div className="bg-squadrun-primary/10 rounded-md p-4">
            ...
            <Progress value={results.coverage} className="h-2 bg-squadrun-darker" />
          </div>
        </div>
