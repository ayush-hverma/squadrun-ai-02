  ...
  return <Card className="border border-squadrun-primary/30 shadow-lg transition-all duration-300 hover:shadow-squadrun-primary/20">
      <CardContent className="p-3 px-px py-px mx-[240px]">
        <div className={`flex flex-col items-center transition-all duration-300 
            ${isDragging ? 'scale-102 border-2 border-dashed border-squadrun-primary bg-squadrun-primary/10 rounded-md' : ''}`} onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
          ...
          <div className="flex flex-col items-center w-full gap-4 p-4">
            ...
            <Button onClick={handleBrowseClick} className="bg-squadrun-primary hover:bg-squadrun-vivid transition-all duration-300 shadow-md hover:shadow-lg text-white w-full">
              Browse Files
            </Button>
          ...
          {fileName && <div className="mt-4 px-4 py-3 bg-squadrun-primary/10 rounded-md text-white w-full text-center animate-fade-in transition-all duration-300 hover:bg-squadrun-primary/20">
